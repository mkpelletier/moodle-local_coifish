...
$string['lecturer_feedback_breakdown_desc'] = 'Per-course feedback quality, showing which courses make up the composite score. Only courses with graded work are listed, worst composite first. Expand a course to see its per-assignment breakdown.';
...
$string['lecturer_feedback_exclude_action'] = 'Not feedback-relevant';
$string['lecturer_feedback_exclude_title'] = 'Mark this assignment as not feedback-relevant and remove it from the feedback analytics';
